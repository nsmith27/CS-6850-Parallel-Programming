    ...
    for (unsigned int thread_work_index = 0; thread_work_index < TOTAL_SIZE; thread_work_index += thread_work_size) {
        ...
        while (sorted_block_size < thread_work_size/4){
            for (int segmentA = 0; segmentA < thread_work_size; segmentA += sorted_block_size * 8){
                ...
                int * startA1 = &Arr[segmentA];
                int * startB1 = &Arr[segmentB];
                int * startC1 = &Arr[segmentC];
                int * startD1 = &Arr[segmentD];
                ...
                __m512i A1 = _mm512_load_si512(startA1); 
                __m512i B1 = _mm512_load_si512(startB1); 
                __m512i C1 = _mm512_load_si512(startC1); 
                __m512i D1 = _mm512_load_si512(startD1); 
                __m512i A2 = _mm512_load_si512(startA2); 
                __m512i B2 = _mm512_load_si512(startB2); 
                __m512i C2 = _mm512_load_si512(startC2); 
                __m512i D2 = _mm512_load_si512(startD2); 
                __m512i A1out;  
                __m512i B1out;  
                __m512i C1out;  
                __m512i D1out;  
                ...
                for (int i = 0; i < (sorted_block_size/8)-1; i++){
                    bitonicSort(A1, A2, A1out, A2out,
                                ...
                                C1, C2, C1out, C2out,
                                D1, D2, D1out, D2out);
                    _mm512_store_si512(startA1 + i*16, A1out);
                    _mm512_store_si512(startB1 + i*16, B1out);
                    _mm512_store_si512(startC1 + i*16, C1out);
                    _mm512_store_si512(startD1 + i*16, D1out);
                    A1 = A2out; 
                    B1 = B2out; 
                    C1 = C2out; 
                    D1 = D2out; 
                    ...
                    if (i == ((sorted_block_size/8)-2) ){
                        _mm512_store_si512(startA1 + i*16+16, A1out);
                        _mm512_store_si512(startB1 + i*16+16, B1out);
                        _mm512_store_si512(startC1 + i*16+16, C1out);
                        _mm512_store_si512(startD1 + i*16+16, D1out);
                    }
                    if (startA1+16 == endA1) {
                        // Finished 1’s side but not 2’s side
                        startA2 += 16;
                        A2 = _mm512_load_si512(startA2);
                    } 
                    else if (startA2+16 == endA2) {
                        // Finished 2's side but not 1’s side
                        startA1 += 16;
                        A2 = _mm512_load_si512(startA1);
                    } 
                    else if (startA1 + 16 < startA2 + 16 ){
                        // use A1’s value
                        startA1 += 16;
                        A2 = _mm512_load_si512(startA1); 
                    } 
                    ...
                    if (startB1+16 == endB1) {
                        // Finished 1’s side but not 2’s side
                        startB2 += 16;
                        B2 = _mm512_load_si512(startB2);
                    } 
                    else if (startB2+16 == endB2) {
                        // Finished 2's side but not 1’s side
                        startB1 += 16;
                        B2 = _mm512_load_si512(startB1);
                    } 
                    else if (startB1 + 16 < startB2 + 16 ){
                        // use A1’s value
                        startB1 += 16;
                        B2 = _mm512_load_si512(startB1); 
                    } 
                    ...
                    if (startC1+16 == endC1) {
                        // Finished 1’s side but not 2’s side
                        startC2 += 16;
                        C2 = _mm512_load_si512(startC2);
                    } 
                    else if (startC2+16 == endC2) {
                        // Finished 2's side but not 1’s side
                        startC1 += 16;
                        C2 = _mm512_load_si512(startC1);
                    } 
                    else if (startC1 + 16 < startC2 + 16 ){
                        // use A1’s value
                        startC1 += 16;
                        C2 = _mm512_load_si512(startC1); 
                    } 
                    ...
                    if (startD1+16 == endD1) {
                        // Finished 1’s side but not 2’s side
                        startD2 += 16;
                        D2 = _mm512_load_si512(startD2);
                    } 
                    else if (startD2+16 == endD2) {
                        // Finished 2's side but not 1’s side
                        startD1 += 16;
                        D2 = _mm512_load_si512(startD1);
                    } 
                    else if (startD1 + 16 < startD2 + 16 ){
                        // use A1’s value
                        startD1 += 16;
                        D2 = _mm512_load_si512(startD1); 
                    } 
